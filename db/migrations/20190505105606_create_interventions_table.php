...
class CreateInterventionsTable extends AbstractMigration
{
    ...
    public function change()
    {
        $this->table('interventions')
            ...
            ->addColumn('inter_type', 'string', ['null' => true])
            ...
            ->addColumn('author_name', 'string', ['null' => true])
            ...
            ->addColumn('nb_views', 'biginteger', ['null' => true])
            ->addColumn('last_view', 'datetime', ['null' => true])
            ->addColumn('i_photo', 'string', ['null' => true])
