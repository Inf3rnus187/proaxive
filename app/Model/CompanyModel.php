...
{
    protected $model = 'pe1x_company'; // Générer un nom de table différent
    ...
    public function all(){
        ...
        return $this->query("
            ...
            LEFT JOIN pe1x_departments as d ON c.department_id = d.id
    ...
    public function find($id, $idParent = false){
        ...
        return $this->query("
            ...
            d.id as did, d.name
            FROM ".$this->model." as c
            LEFT JOIN pe1x_departments as d ON d.id = c.department_id
            WHERE c.id = ?", [$id], true);
